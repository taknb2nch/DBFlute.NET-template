...
using Aaa.Bbb.Ccc.DBFlute.AllCommon.CBean.OutsideSql.Executor;
...
namespace Aaa.Bbb.Ccc.DBFlute.AllCommon.Bhv {
    ...
    public abstract class AbstractBehaviorReadable : BehaviorReadable {
        ...
        //                                                                          DBMeta
        //                                                                          ======
        public abstract DBMeta DBMeta { get; }
        ...
        //                                                                      Count Read
        //                                                                      ==========
        public virtual int ReadCount(ConditionBean cb) {
        ...
        //                                                                     Entity Read
        //                                                                     ===========
        public virtual Entity ReadEntity(ConditionBean cb) {
            AssertConditionBeanNotNull(cb);
        ...
        public virtual Entity ReadEntityWithDeletedCheck(ConditionBean cb) {
            AssertConditionBeanNotNull(cb);
        ...
        protected void AssertEntityNotDeleted<ENTITY_TYPE>(IList<ENTITY_TYPE> ls, Object searchKey4Log) where ENTITY_TYPE : Entity {
            if (ls == null || ls.Count == 0) {
                ThrowEntityAlreadyDeletedException(searchKey4Log);
            }
        }

        protected void AssertEntitySelectedAsOne<ENTITY_TYPE>(IList<ENTITY_TYPE> ls, Object searchKey4Log) where ENTITY_TYPE : Entity {
            if (ls == null || ls.Count == 0) {
				ThrowEntityAlreadyDeletedException(searchKey4Log);
            }
            if (ls.Count != 1) {
        ...
        //                                                                  Various Select
        //                                                                  ==============
        public virtual OutsideSqlBasicExecutor OutsideSql() {
            AssertDaoSelectorNotNull("OutsideSql");
            OutsideSqlDao outsideSqlDao = _daoSelector.Select<OutsideSqlDao>();
            return new OutsideSqlBasicExecutor(outsideSqlDao, this.TableDbName);
        }
        ...
        protected IList<FOREIGN_ENTITY> HelpPulloutInternally<LOCAL_ENTITY, FOREIGN_ENTITY>(IList<LOCAL_ENTITY> localEntityList, InternalPulloutCallback<LOCAL_ENTITY, FOREIGN_ENTITY> callback)
                where LOCAL_ENTITY : Entity where FOREIGN_ENTITY : Entity {
            AssertObjectNotNull("localEntityList", localEntityList);
        ...
        protected interface InternalPulloutCallback<LOCAL_ENTITY, FOREIGN_ENTITY> where LOCAL_ENTITY : Entity where FOREIGN_ENTITY : Entity {
        ...
        //                                                            ====================
        protected abstract bool HasVersionNoValue(Entity entity);
        protected abstract bool HasUpdateDateValue(Entity entity);

        // ===============================================================================
        //                                                                  Process Method
        //                                                                  ==============
        protected virtual void FilterEntityOfInsert(Entity targetEntity) { // for isAvailableNonPrimaryKeyWritable
        }
        ...
        protected virtual void AssertEntityNotNull(Entity entity) {
            AssertObjectNotNull("entity", entity);
        }

        protected virtual void AssertConditionBeanNotNull(Aaa.Bbb.Ccc.DBFlute.AllCommon.CBean.ConditionBean cb) {
            AssertObjectNotNull("cb", cb);
        }

        protected virtual void AssertEntityNotNullAndHasPrimaryKeyValue(Entity entity) {
