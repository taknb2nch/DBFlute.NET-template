...
namespace Aaa.Bbb.Ccc.DBFlute.AllCommon.Bhv {
    ...
    public abstract class AbstractBehaviorWritable : AbstractBehaviorReadable, BehaviorWritable {
        ...
        protected virtual void SetupCommonColumnOfInsertIfNeeds(Entity targetEntity) {
            ...
            DateTime? createdDatetime = Aaa.Bbb.Ccc.DBFlute.AllCommon.AccessContext.GetAccessTimestampOnThread();
            entity.CreatedDatetime = createdDatetime;
            
            String createdUser = Aaa.Bbb.Ccc.DBFlute.AllCommon.AccessContext.GetAccessUserOnThread();
            entity.CreatedUser = createdUser;
            
            DateTime? updatedDatetime = entity.CreatedDatetime;
            entity.UpdatedDatetime = updatedDatetime;
            
            String updatedUser = entity.CreatedUser;
        ...
        protected virtual void SetupCommonColumnOfUpdateIfNeeds(Entity targetEntity) {
            ...
            DateTime? updatedDatetime = Aaa.Bbb.Ccc.DBFlute.AllCommon.AccessContext.GetAccessTimestampOnThread();
            entity.UpdatedDatetime = updatedDatetime;
            
            String updatedUser = Aaa.Bbb.Ccc.DBFlute.AllCommon.AccessContext.GetAccessUserOnThread();
            entity.UpdatedUser = updatedUser;
              }

        protected virtual void FilterEntityOfUpdate(Aaa.Bbb.Ccc.DBFlute.AllCommon.Entity targetEntity) {
        }

        protected virtual void AssertEntityOfUpdate(Aaa.Bbb.Ccc.DBFlute.AllCommon.Entity entity) {
        }
