...
namespace Aaa.Bbb.Ccc.DBFlute.AllCommon.S2Dao {
    ...
    public class S2DaoSelectDynamicCommand : SelectDynamicCommand {
        ...
        protected virtual object[] FilterArgumentsForDataReaderHandler(object[] args) {
            ...
            object[] filteredArgs;
            if (args[args.Length - 1] is Aaa.Bbb.Ccc.DBFlute.AllCommon.Ado.CursorHandler) {
        ...
        protected IDataReaderHandler FindSpecifiedDataReaderHandler(object[] args) {
            ...
            if (args[args.Length-1] is Aaa.Bbb.Ccc.DBFlute.AllCommon.Ado.CursorHandler) {
                Aaa.Bbb.Ccc.DBFlute.AllCommon.Ado.CursorHandler cursorHandler = (Aaa.Bbb.Ccc.DBFlute.AllCommon.Ado.CursorHandler)args[args.Length-1];
        ...
        protected class DataReaderCursol : IDataReaderHandler {
            protected Aaa.Bbb.Ccc.DBFlute.AllCommon.Ado.CursorHandler _cursorHandler;
            public DataReaderCursol(Aaa.Bbb.Ccc.DBFlute.AllCommon.Ado.CursorHandler cursorHandler) {
